...
export default function ProfilePage() {
  ...
  const handlePiLogin = async () => {
    try {
      ...
      if (sessionToken) {
        window.localStorage.setItem("pi_session_token", sessionToken)
      }
    ...
    <main style={{ ...pageStyle, direction: dir }}>
      <div style={containerStyle}>
        ...
        <div style={linksGridStyle}>
          ...
          <Link href="/create-written-course" style={linkCardStyle}>
            {lang === "ar" ? "إنشاء دورة مكتوبة" : "Create Written Course"}
          </Link>

          <Link href="/admin/visits" style={linkCardStyle}>
            {lang === "ar" ? "لوحة الزوار" : "Visits Dashboard"}
          </Link>
        </div>
      </div>
